...
export const mockVendors: Vendor[] = [
  { id: 'vendor-1', leadId: 'SKPA01', name: 'Shree Krishna Parts', contacts: [{id: 'vc-1', name: 'Shree Krishna', phone: '8123456780', email: 'skp@gmail.com', designation: 'Owner', isPrimary: true}], status: 'Active', anchorId: 'anchor-1', assignedTo: 'user-1', createdAt: today.toISOString(), leadDate: today.toISOString(), product: 'SCF - Primary', leadSource: 'Anchor Ecosystem (Cross-sell)', leadScore: 90, leadScoreReason: "Long-standing supplier for a major anchor, indicating reliability.", leadType: 'Fresh' },
  { id: 'vendor-2', leadId: 'BACO02', name: 'Balaji Components', contacts: [{id: 'vc-2', name: 'Balaji', phone: '8123456781', email: '', designation: 'Manager', isPrimary: true}], status: 'Partial Docs', anchorId: 'anchor-1', assignedTo: 'user-1', createdAt: today.toISOString(), leadDate: today.toISOString(), product: 'SCF - Primary', leadSource: 'Connector', leadType: 'Fresh', nextBestAction: { recommendedAction: 'Address a Specific Question', justification: 'KYC is pending, follow up to see if they have any questions holding them back.' } },
  { id: 'vendor-3', leadId: 'UNVE03', name: 'Unassigned Vendors Inc', contacts: [{id: 'vc-3', name: 'Unassigned', phone: '8123456782', email: 'contact@unassigned.co', designation: 'Contact', isPrimary: true}], status: 'Unassigned Lead', anchorId: null, assignedTo: null, createdAt: today.toISOString(), leadDate: today.toISOString(), city: 'Chennai', product: 'Other', leadSource: 'Website Inquiry', leadType: 'Fresh' },
];
